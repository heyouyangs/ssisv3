...
def edit_course():
    ...
    colleges = get_colleges_codes()
    return render_template('editcourses.html', course_code=course_code, course_name=course_name, college_code=college_code, colleges=colleges)
